-- Selecionando o meu banco de dados
USE autopecas_db;

-- Inserindo Clientes (TODOS OS O IDs de cada tabela são AUTO_INCREMENT)
...
-- (Assumindo que os produtos acima são IDs 1, 2, 3, 4 e as categorias são 1, 2, 3, 4 para facilitar na população)
